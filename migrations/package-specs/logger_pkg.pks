CREATE OR REPLACE PACKAGE logger_pkg IS
   ...
   c_level_none         CONSTANT NUMBER (2,0) := 32;
   c_level_fatal        CONSTANT NUMBER (2,0) := 16;
   c_level_error        CONSTANT NUMBER (2,0) := 8;
   c_level_warn         CONSTANT NUMBER (2,0) := 4;
   c_level_info         CONSTANT NUMBER (2,0) := 2;
   c_level_debug        CONSTANT NUMBER (2,0) := 1;
   c_level_all          CONSTANT NUMBER (2,0) := 0;

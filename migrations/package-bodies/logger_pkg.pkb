CREATE OR REPLACE PACKAGE BODY logger_pkg IS
   ...
   g_undefined_string        VARCHAR2 (30) := 'UNKNOWN';
   ...
   BEGIN
      ...
      ELSE
         v_call_entry.log_guid := NULL;
         v_call_entry.source := g_undefined_string;
         v_call_entry.code_location := g_undefined_string;
      END IF;
   ...
   BEGIN
      ...
      EXCEPTION
         WHEN OTHERS THEN
            g_session_info_rec.instance_name := g_undefined_string;
      END;
   ...
   PROCEDURE write_to_console (pi_trace_level     IN processing_log.trace_level%TYPE,
      ...
      v_source          processing_log.source%TYPE;
      v_code_location   processing_log.code_location%TYPE;
      v_log_time        processing_log.start_time%TYPE;
      v_trace_level     processing_log.trace_level%TYPE;
      v_message         processing_log.MESSAGE%TYPE;
   BEGIN
      ...
      v_trace_level := RPAD (NVL (pi_trace_level, g_undefined_string), 12, ' ');
   ...
   BEGIN
      IF pio_log_guid IS NULL THEN
         ...
         INSERT INTO processing_log (log_guid,
              ...
              VALUES (
                        pio_log_guid,
                        NVL (pi_trace_level, g_undefined_string),
